package com.example.brickapp.domain.geo

import com.example.brickapp.domain.model.Bearing
import com.example.brickapp.domain.model.Coordinates
import com.google.common.truth.Truth.assertThat
import org.junit.Test

/**
 * Validates the pure-Kotlin haversine and bearing implementations against known city-pair
 * distances and cardinal directions. These tests prove the "domain is Android-free" premise —
 * they run on the JVM in milliseconds with zero Android dependencies.
 */
class GeoMathTest {
